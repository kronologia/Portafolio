...
// por lo que este archivo debería llamarse "CONO.java."
...
public class cono {
	...
	public static void main(String args[]) throws IOException {
		...
		p = 0;
		p = 3.14;
		System.out.println("Programa que calcule área y volumen de un cono");
		...
		x = p*r*(g+r);
		l = (p*r*r*h)/3;
		System.out.println("El área del cono es:"+x);
